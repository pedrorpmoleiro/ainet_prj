                    ...
                    <div class="card-body">
                        <form action="{{ action('UserController@patchPassword') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="old_password" class="col-md-4 col-form-label text-md-right">Senha
                                    Antiga</label>
                            ...
                            <div class="form-group row">
                                <label for="password_confirmation" class="col-md-4 col-form-label text-md-right">Confirme
                                    a nova senha</label>
